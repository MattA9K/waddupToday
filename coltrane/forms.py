...
class EntryFormURL(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields[
            'body'].help_text = "Enter a YouTube video URL or Vimeo URL (example: https://www.youtube.com/watch?v=uK367T7h6ZY, http://vimeo.com/72699930). For hashtags, put the hashtag in the title."
